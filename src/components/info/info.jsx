    ...
    <div>
      ...
      <main className="main">
        ...
        <p className="name-section-description">
          Creative full-stack developer with 1 year
          of experience. Proficient in Python, Javascript (MERN stack)
          and SQL.
        </p>
        <ul className="social-list">
          <li className="social-item">
            <a href="https://www.linkedin.com/in/roberto-quadraccia/"></a>
          </li>
        </ul>
        </div>
